...
<head>
    ...
    <title>عسل - تقرير الدفوعات</title>
...
<div class="d-flex align-items-stretch">
    <div id="sidebar" class="sidebar py-3">
        ...
        <ul class="sidebar-menu list-unstyled">
            ...
            <li class="sidebar-list-item"><a href="payment_report.php" class="sidebar-link text-muted active"><i class="o-survey-1 mr-3 text-gray"></i><span style="margin-right: 8px">تقرير المدفوعات</span></a></li>
...
<script>
    ...
    function getPaymentData(a) {
        var x = (a.value || a.options[a.selectedIndex].value);  //crossbrowser solution =)
        fetchPaymentDataFromServer(x);
    }

    function fetchPaymentDataFromServer(session_id) {
        var url = "https://3assal.net/scripts/fetchPaymentReport.php?session_id=" + session_id;
