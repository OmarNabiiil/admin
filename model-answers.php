...
<head>
    ...
    <title>عسل - نماذج الإجابات</title>
...
<div class="d-flex align-items-stretch">
    <div id="sidebar" class="sidebar py-3">
        ...
        <ul class="sidebar-menu list-unstyled">
            ...
            <li class="sidebar-list-item"><a href="model-answers.php" class="sidebar-link text-muted active"><i class="o-survey-1 mr-3 text-gray"></i><span style="margin-right: 8px">نماذج الإجابات</span></a></li>
    ...
    <div class="modal fade" dir="rtl" id="addModelAnswerModal" tabindex="-1" role="dialog" aria-labelledby="addModelAnswerModalLabel" aria-hidden="true">
        <div class="modal-dialog" role="document">
            <div class="modal-content">
                <div class="modal-header">
                    <h5 class="modal-title" id="addModelAnswerModalLabel">إضافة نموذج إجابة</h5>
                    <button type="button" class="close" data-dismiss="modal" style="margin-left: 0" aria-label="Close">
                        <span aria-hidden="true">&times;</span>
                    </button>
                </div>
                <div class="modal-body">
                    ...
                    <form id="addModelAnswerForm" action="#" role="form" method="post" class="addModelAnswerForm" enctype="multipart/form-data">

                        <div class="form-group">
                            <label for="inputBody">الإسم</label>
                            <input class="form-control" name="inputBody" id="inputBody" rows="2" placeholder="الإسم">
                        </div>
            ...
            <section class="py-5">
                ...
                <div class="row">
                    <div class="col-lg-2 mb-4">
                        <button id="addModelAnswerButton" class="btn btn-primary addModelAnswerButton" data-toggle="modal" data-target="#addModelAnswerModal">إضافة نموذج إجابة</button>
                    </div>
                </div>
                    ...
                    <div class="col-lg-12 mb-4">
                        <div class="card">
                            <div class="card-header">
                                <h6 class="text-right mb-0">نماذج الإجابات</h6>
                            </div>
                            <div class="card-body">
...
<script>
    ...
    $(document).ready( function () {
        ...
        $(document).on('submit', '#addModelAnswerModal', function(event){
            event.preventDefault();
            let form = document.querySelector('#addModelAnswerForm');
            //$('#action').modal('hide');
            $.ajax({
                url:"https://3assal.net/scripts/addModelAnswer.php",
                method:'POST',
